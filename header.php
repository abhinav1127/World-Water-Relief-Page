...
<div id="page" class="hfeed site">
	...
	<?php endif; ?>
			...
			<div class="sixteen columns">
					...
					<div class="logo six column site-branding">

						<?php if( isset( $flaton['site-title'] ) && isset( $flaton['custom-logo'] ) && $flaton['site-title'] ) : ?>

                     <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo $flaton['custom-logo']['url']; ?>" alt="logo" > </a>
             ...
             <div class="compaign eight column  pull-right">


                 

              <a href="<?php echo get_site_url(); ?>/you-can-help/donate/" title="" class="btn_link donate_btn"><span class="btn_name "> donate </span> 
