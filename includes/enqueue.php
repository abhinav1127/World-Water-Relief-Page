 ...
 */
if(!function_exists("flaton_fontawesome")){
...
if(!function_exists("flaton_scripts")){
function flaton_scripts() {
 ...
 wp_enqueue_style( 'bootstrap', FLATON_PARENT_URL . '/css/bootstrap.css' );
 wp_enqueue_style( 'style', FLATON_PARENT_URL . '/css/style2.css' );
 wp_enqueue_style( 'animate', FLATON_PARENT_URL . '/css/animate.min.css' );
 wp_enqueue_style( 'responsive', FLATON_PARENT_URL . '/css/responsive.css' );
    ...
    wp_enqueue_script( 'jquery.parallax', false, array('jquery'));
...
if(!function_exists("flaton_admin_style")){
